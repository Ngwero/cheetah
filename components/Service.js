...
const Service1 = () => {
  return (
    <section className="trusted-client-section live-sports-section fix section-padding pt-0 mg-top-20">
            ...
            <div className="col-xl-7 mt-5 mt-xl-0">
              <div className="trusted-content">
                ...
                <p className="mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                  CheetahNet provides cutting-edge internet and TV services to 
                  homes and businesses across Uganda. Experience seamless streaming, 
                  reliable connectivity, and exceptional customer support.
                </p>
