            ...
            <div className="col-lg-6 mt-5 mt-lg-0">
              <div className="about-content">
                ...
                <p className=" mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                  CheetahNet is Uganda's premier internet service provider, 
                  delivering high-speed broadband and fiber optic connectivity 
                  to homes and businesses across Kampala and throughout Uganda. 
                  We are committed to bridging the digital divide and empowering 
                  communities with reliable internet access.
                </p>
