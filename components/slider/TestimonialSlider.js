                ...
                <div className="col-lg-11">
                  <div className="testimonial-items">
                    ...
                    <div className="client-info">
                      <h5>James Mukasa</h5>
                      <h6>
                        Director of <span>Kampala Tech Solutions</span>
                      </h6>
                    </div>
                    <div className="testimonial-content">
                      <h3>
                        " CheetahNet has transformed our business operations in Kampala. 
                        Their reliable fiber connection has enabled us to serve clients 
                        seamlessly. The customer support team is always responsive and 
                        professional. Highly recommended for businesses in Uganda! "
                      </h3>
                      <div className="star">
                        <span className="fas fa-star" />
                        <span className="fas fa-star" />
