            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  ...
                  <div className="social-icon d-flex align-items-center" style={{ marginTop: '20px' }}>
            ...
            >
              <div className="single-footer-widget">
                ...
                <ul className="list-items">
                  <li>
                    <Link href="service-details">Broadband Internet</Link>
                  </li>
                  <li>
                    <Link href="service-details">Fiber Optic</Link>
                  </li>
                  <li>
                    <Link href="service-details">WiFi Solutions</Link>
                  </li>
                  <li>
                    <Link href="service-details">Business Internet</Link>
                  </li>
                  <li>
                    <Link href="service-details">Cloud Services</Link>
                  </li>
                  <li>
                    <Link href="service-details">TV Streaming</Link>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <footer className="footer-section section-bg-3">
      <div className="container">
        <div className="footer-top">
          ...
          <p className="wow fadeInUp" data-wow-delay=".4s" style={{ color: '#999', fontSize: '14px', marginBottom: '15px' }}>
            Follow us on X (Twitter) <a href="https://x.com/CheetahNetUg" target="_blank" rel="noopener noreferrer" style={{ color: '#ff8c00' }}>@CheetahNetUg</a> for the latest updates, network news, and exclusive offers.
          </p>
          <ul className="wow fadeInUp" data-wow-delay=".5s">
            <li>
              <i className="fab fa-facebook-f" />
              <a href="https://www.facebook.com/share/1BAur7WwFw/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">Facebook</a>
            </li>
            <li>
              <i className="fab fa-twitter" />
              <a href="https://x.com/CheetahNetUg" target="_blank" rel="noopener noreferrer">Twitter</a>
            </li>
            <li>
          ...
          <div className="col-lg-6">
            <div className="newsletter-area style-2">
              ...
              <div
                ...
                data-wow-delay=".6s"
              >
                <a href="https://www.facebook.com/share/1BAur7WwFw/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-facebook-f" />
                </a>
                <a href="https://x.com/CheetahNetUg" target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-twitter" />
                </a>
                <a href="#">
