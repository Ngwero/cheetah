              ...
              <div className="col-lg-6 mt-5 mt-lg-0">
                <div className="about-content">
                  ...
                  >
                    ...
                    dedicated to connecting homes and businesses across Kampala 
                    and beyond with reliable, high-speed broadband solutions.
                  </p>
        ...
        <div className="container">
          <div className="cta-parallax-wrapper text-center">
            ...
            <div className="button-items">
              ...
              <a href="tel:+256771099075" className="theme-btn bg-white">
                <span>
                  +256 771 099075 <i className="fas fa-chevron-right" />
                </span>
              </a>
            </div>
          </div>
